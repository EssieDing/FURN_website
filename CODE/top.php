...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="hmtop" >
			<!--顶部导航条 -->
			<div class="am-container header" style="background: rgb(230,230,230);max-width:2000px">
				<ul class="message-l">
					<div class="topMessage">
						...
						<?php }else{?>
						<div class="menu-hd">
							<a href="user/login.php" target="_top" class="h">Please Login&nbsp&nbsp&nbsp|</a>
				...
				<ul class="message-r" >
					...
					<div class="topMessage my-shangcheng">
						<div class="menu-hd MyShangcheng"><a href="user/center.php?uid=<?php echo $uid?>" target="_top"><i class="am-icon-user am-icon-fw"></i>My Page&nbsp&nbsp&nbsp|</a></div>
					</div>
					<div class="topMessage mini-cart">
						<div class="menu-hd"><a id="mc-menu-hd" href="user/cart.php?uid=<?php echo $uid?>" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>Shop Car</span><strong id="J_MiniCartNum" class="h"></strong></a></div>
					</div>
